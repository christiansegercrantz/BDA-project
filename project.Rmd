...
In Table \@ref(tab:loo_comp_old) we can see the the comparison of the nonhierarchical and hierarchical models for the old age group and in Table \@ref(tab:loo_comp_old) the respective information for the young group.
