...
We use weekly informative priors for parameters $$\mu$$ and $$\sigma$$. They are chosen based on the blood pressure data that we get from the dataset. From The plotted data we get weekly  
>>>>>>> Stashed changes
