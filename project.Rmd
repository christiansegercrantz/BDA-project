...
<<<<<<< Updated upstream
The whole dataset with diastolic blood pressure by age looks like this.
=======
...
-  For $$Age \leq 30: Prior\mu = 65,\:Prior\sigma=10,\: PriorVar=20$$. Our prior $$\mu$$ is slightly lower here than for the older age group. Other priors stay the same.
-  For $$Age > 30: Prior\mu = 75,\:Prior\sigma=10,\: PriorVar=20$$. Here the prior $$\mu$$ is higher but other priors stay the same.
...
We use weekly informative priors for parameters $$\mu$$ and $$\sigma$$. They are chosen based on the blood pressure data that we get from the data set. From The plotted data we get weekly  
